              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        ...
                        Text(
                          'Banglore',
                          style: TextStyle(fontSize: 6, fontWeight: FontWeight.w400, color: ColorResources.txcolour),
                        )
                      ],
                    ),
                    SizedBox(
                ...
                Row(
                  children: [
                    Text(
                      'Trending courses',
                      style: GoogleFonts.poppins(color: Colors.black, fontSize: Dimensions.fontSizeLarge, fontWeight: FontWeight.w500),
                    ),
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            '4 years duration',
                            style: GoogleFonts.poppins(fontSize: Dimensions.fontSizeDefault, color: Colors.white),
                          )
                        ],
                      ),
                ...
                Row(
                  children: [
                    ...
                    Text(
                      'Continue searching',
                      style: GoogleFonts.poppins(color: Colors.black, fontSize: Dimensions.fontSizeDefault, fontWeight: FontWeight.w500),
                    ),
                  ],
                ),
                const SizedBox(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return AspectRatio(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(borderRadius: BorderRadius.circular(15), color: ColorResources.txcolour),
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Column(
                ...
                Column(
                  children: [
                    Container(
                      height: 300,
                      decoration: BoxDecoration(
                        image: const DecorationImage(fit: BoxFit.cover, image: AssetImage('assets/unsplash_bgQgAKagQB4.png')),
                        borderRadius: BorderRadius.circular(10),
                        color: Colors.white,
                        boxShadow: const [
                          BoxShadow(color: Color.fromARGB(84, 158, 158, 158), blurRadius: 4, offset: Offset(0, 3)),
                        ],
                      ),
                      child: Column(
                        children: [
                          ...
                          Expanded(
                              ...
                              child: Container(
                                ...
                                decoration: const BoxDecoration(color: Colors.white, borderRadius: BorderRadius.vertical(bottom: Radius.circular(10))),
                                child: Row(
                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  children: [
                                    Column(
